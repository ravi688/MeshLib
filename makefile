...
DEPENDENCIES = BufferLib TemplateSystem HPML BufferLib/dependencies/CallTrace
DEPENDENCY_LIBS = BufferLib/lib/bufferlib.a HPML/lib/hpml.a BufferLib/dependencies/CallTrace/lib/calltrace.a
