...
#Dependencies
DEPENDENCY_LIBS = ./dependencies/HPML/lib/hpml.a ./dependencies/BufferLib/lib/bufferlib.a
DEPENDENCY_INCLUDES = ./dependencies/HPML/include ./dependencies/BufferLib/include ./dependencies/TemplateSystem/include
